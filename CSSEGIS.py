...
def update_figure(selected):
    ...
    trace = go.Choropleth(locations=data['confirmed_nzd']['data'].T.index, # Spatial coordinates
                          z = data['confirmed_nzd']['data'].T[date.today()-timedelta(days=1)], # Data to be color-coded
